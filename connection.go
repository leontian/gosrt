...
func (c *srtConn) Stats(s *Statistics) {
	...
	s.Accumulated = StatisticsAccumulated{
		...
		PktRecvDelivered:  recv.PktDelivered,
		PktRecvOOO:        recv.PktOOO,
	...
	s.Interval = StatisticsInterval{
		...
		PktRecvDelivered:   s.Accumulated.PktRecvDelivered - previous.PktRecvDelivered,
		PktRecvOOO:         s.Accumulated.PktRecvOOO - previous.PktRecvOOO,
